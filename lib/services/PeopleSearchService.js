                        ...
                        userResults = values.map(function (element) {
                            ...
                            switch (element.EntityType) {
                                case 'User':
                                    ...
                                    var jobTitle = ((_b = element.EntityData) === null || _b === void 0 ? void 0 : _b.Title) || "";
                                    return {
                                        id: element.Key,
                                        ...
                                        secondaryText: jobTitle != "" ? jobTitle + " | " + email : email,
                                        tertiaryText: email,
                                        optionalText: "" // anything
                                    };
                                case 'SecGroup':
                                    var secondaryText = ((_c = element.EntityData) === null || _c === void 0 ? void 0 : _c.Email) || element.ProviderName;
                                    return {
                                        id: element.Key,
                                        loginName: element.LoginName ? element.LoginName : element.Key,
                                        imageInitials: _this.getFullNameInitials(element.DisplayText),
