...
import { DocumentCard, DocumentCardActivity, DocumentCardLocation, DocumentCardPreview, DocumentCardTitle, DocumentCardType } from "office-ui-fabric-react/lib/DocumentCard";
    ...
    ControlsTest.prototype.render = function () {
       ...
       */
        ...
        return (React.createElement("div", { className: styles.controlsTest },
            ...
            React.createElement(AccessibleAccordion, { allowZeroExpanded: true },
            ...
            React.createElement(RichText, { value: this.state.richTextValue, isEditMode: this.props.displayMode === DisplayMode.Edit, onChange: function (value) { _this.setState({ richTextValue: value }); return value; } }),
            React.createElement(PrimaryButton, { text: 'Reset text', onClick: function () { _this.setState({ richTextValue: 'test' }); } }),
            React.createElement(Placeholder, { iconName: 'Edit', iconText: 'Configure your web part', description: function (defaultClassNames) { return React.createElement("span", { className: defaultClassNames }, "Please configure the web part."); }, buttonLabel: 'Configure', hideButton: this.props.displayMode === DisplayMode.Read, onConfigure: this._onConfigure }),
            ...
            React.createElement(PeoplePicker, { context: this.props.context, titleText: "People Picker (tenant scoped)", personSelectionLimit: 5, 
                ...
                onChange: this._getPeoplePickerItems, showHiddenInUI: false, principalTypes: [PrincipalType.User, PrincipalType.SharePointGroup, PrincipalType.SecurityGroup, PrincipalType.DistributionList], suggestionsLimit: 2, resolveDelay: 200, placeholder: 'Select a SharePoint principal (User or Group)', onGetErrorMessage: function (items) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
            ...
            React.createElement("br", null),
            React.createElement(ListView, { items: this.state.items, viewFields: viewFields, iconFieldName: 'ServerRelativeUrl', groupByFields: groupByFields, compact: true, selectionMode: SelectionMode.single, selection: this._getSelection, showFilter: true, dragDropFiles: true, onDrop: this._getDropFiles, stickyHeader: true }),
            ...
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: "ms-Grid-row ms-bgColor-neutralLight ms-fontColor-neutralDark " + styles.row },
                    React.createElement("div", { className: "ms-Grid-col ms-lg10 ms-xl8 ms-xlPush2 ms-lgPush1" },
                        ...
                        React.createElement("div", { className: "ms-font-m" },
                            ...
                            React.createElement(ListItemPicker, { listId: '76a8231b-35b6-4703-b1f4-5d03d3dfb1ca', columnInternalName: "Title", keyColumnInternalName: "Id", filter: "Title eq 'SPFx'", orderBy: 'Title desc', itemLimit: 5, context: this.props.context, placeholder: 'Select list items', onSelectedItem: this.listItemPickerDataSelected })),
                        ...
                        React.createElement("div", { className: "ms-font-m" },
                            ...
                            React.createElement(ComboBoxListItemPicker, { listId: this.state.comboBoxListItemPickerListId, columnInternalName: 'Title', keyColumnInternalName: 'Id', multiSelect: true, onSelectedItem: function (data) {
            ...
            React.createElement("div", null,
                ...
                React.createElement(Carousel, { buttonsLocation: CarouselButtonsLocation.center, buttonsDisplay: CarouselButtonsDisplay.buttonsOnly, contentContainerStyles: styles.carouselImageContent, 
                    ...
                    ], onMoveNextClicked: function (index) { console.log("Next button clicked: " + index); }, onMovePrevClicked: function (index) { console.log("Prev button clicked: " + index); }, rootStyles: mergeStyles({
            ...
            React.createElement("div", null,
                ...
                React.createElement(FilePicker, { bingAPIKey: "<BING API KEY>", defaultFolderAbsolutePath: this.state.filePickerDefaultFolderAbsolutePath, 
                    //accepts={[".gif", ".jpg", ".jpeg", ".bmp", ".dib", ".tif", ".tiff", ".ico", ".png", ".jxr", ".svg"]}
                    buttonLabel: "Add File", buttonIconProps: { iconName: 'Add', styles: { root: { fontSize: 42 } } }, onSave: this._onFilePickerSave, onChange: function (filePickerResult) { console.log(filePickerResult); }, context: this.props.context, hideRecentTab: false, includePageLibraries: true }),
            ...
            React.createElement(IconPicker, { buttonLabel: 'Icon', onChange: function (iconName) { console.log(iconName); }, onSave: function (iconName) { console.log(iconName); } }),
            React.createElement("div", null,
